...
namespace ThiTracNghiem
{
    ...
    partial void DeleteKyThi(KyThi instance);
		...
		public System.Data.Linq.Table<BaiLam> BaiLam
		{
			get
			{
		...
		public System.Data.Linq.Table<BuoiThi> BuoiThi
		{
			get
			{
		...
		public System.Data.Linq.Table<CapDo> CapDo
		{
			get
			{
		...
		public System.Data.Linq.Table<CauHoi> CauHoi
		{
			get
			{
		...
		public System.Data.Linq.Table<CT_BaiLam> CT_BaiLam
		{
			get
			{
		...
		public System.Data.Linq.Table<CT_DeThi> CT_DeThi
		{
			get
			{
		...
		public System.Data.Linq.Table<CT_GiangDay> CT_GiangDay
		{
			get
			{
		...
		public System.Data.Linq.Table<DapAn> DapAn
		{
			get
			{
		...
		public System.Data.Linq.Table<DeThi> DeThi
		{
			get
			{
		...
		public System.Data.Linq.Table<GiaoVien> GiaoVien
		{
			get
			{
		...
		public System.Data.Linq.Table<HocSinh> HocSinh
		{
			get
			{
		...
		public System.Data.Linq.Table<KhoiLop> KhoiLop
		{
			get
			{
		...
		public System.Data.Linq.Table<LoaiNguoiDung> LoaiNguoiDung
		{
			get
			{
		...
		public System.Data.Linq.Table<MonHoc> MonHoc
		{
			get
			{
		...
		public System.Data.Linq.Table<KyThi> KyThi
		{
			get
			{
    ...
    partial void OnDiemSoChanged();
		...
		public EntitySet<CT_BaiLam> CT_BaiLam
		{
			get
			{
			...
			set
			{
							...
							|| (this._BuoiThi.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.BaiLam.Remove(this);
					}
					this._BuoiThi.Entity = value;
					if ((value != null))
					{
						value.BaiLam.Add(this);
    ...
    partial void OnNgayGioThiChanged();
		...
		public EntitySet<BaiLam> BaiLam
		{
			get
			{
			...
			set
			{
							...
							|| (this._DeThi.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.BuoiThi.Remove(this);
					}
					this._DeThi.Entity = value;
					if ((value != null))
					{
						value.BuoiThi.Add(this);
						this._maDT = value.maDT;
					}
					else
					{
    ...
    partial void OnGoiYChanged();
		...
		public EntitySet<CT_DeThi> CT_DeThi
		{
			get
			{
			...
			set
			{
							...
							|| (this._KhoiLop.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.CauHoi.Remove(this);
					}
					this._KhoiLop.Entity = value;
					if ((value != null))
					{
						value.CauHoi.Add(this);
			...
			set
			{
							...
							|| (this._BaiLam.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.CT_BaiLam.Remove(this);
					}
					this._BaiLam.Entity = value;
					if ((value != null))
					{
						value.CT_BaiLam.Add(this);
						this._maHS = value.maHS;
						this._maKT = value.maKT;
						this._maDT = value.maDT;
					}
			...
			set
			{
							...
							|| (this._CauHoi.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.CT_DeThi.Remove(this);
					}
					this._CauHoi.Entity = value;
					if ((value != null))
					{
						value.CT_DeThi.Add(this);
						this._maCH = value.maCH;
					}
					else
					{
		...
		public CauHoi CauHoi
		{
			...
			set
			{
							...
							|| (this._CauHoi.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._CauHoi.Entity = null;
						previousValue.DapAn.Remove(this);
					}
					this._CauHoi.Entity = value;
					if ((value != null))
					{
						value.DapAn.Add(this);
						this._maCH = value.maCH;
					}
					else
					{
    ...
    partial void OnNgayTaoChanged();
		...
		public EntitySet<BuoiThi> BuoiThi
		{
			get
			{
		...
		public KhoiLop KhoiLop
		{
			...
			set
			{
							...
							|| (this._KhoiLop.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._KhoiLop.Entity = null;
						previousValue.DeThi.Remove(this);
					}
					this._KhoiLop.Entity = value;
					if ((value != null))
					{
						value.DeThi.Add(this);
						this._maKhoi = value.maKhoi;
					}
					else
					{
    ...
    partial void OnmaKhoiChanged();
		...
		public EntitySet<CauHoi> CauHoi
		{
			get
			{
				return this._CauHois;
		...
		public EntitySet<LopHoc> LopHoc
		{
			get
			{
		...
		public KhoiLop KhoiLop
		{
			...
			set
			{
							...
							|| (this._KhoiLop.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._KhoiLop.Entity = null;
						previousValue.LopHoc.Remove(this);
					}
					this._KhoiLop.Entity = value;
					if ((value != null))
					{
						value.LopHoc.Add(this);
						this._maKhoi = value.maKhoi;
					}
					else
					{
