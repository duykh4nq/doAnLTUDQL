...
namespace ThiTracNghiem
{
    public partial class frmHocSinh : Form
    {
            ...
            try
            {
                ...
                if (!string.IsNullOrWhiteSpace(txtMatKhauCu.Text) && !string.IsNullOrWhiteSpace(txtMatKhauMoi.Text))
                {
                    if (hs.NguoiDung.MatKhau == txtMatKhauCu.Text)
                    {
                        ...
                        qlttn.HocSinhs.Where(hs1 => hs1.maHS == hs.maHS).FirstOrDefault().NguoiDung.MatKhau = txtMatKhauMoi.Text;
                    }
                    else
                    {
        ...
        /// <summary>
        /// Ẩn hiện các control con bên trong control mẹ
        /// </summary>
        /// <param name="c">control mẹ</param>
        /// <param name="hide">hide = false nghĩa là ẩn, == true là hiện</param>
        ...
        private void loadDgvDaThi()
        {
            if (cbKyThis.SelectedValue != null)
            {
                ...
                try
                {
                    ...
                    {
                        bt.DeThi.MonHoc.tenMH,
                        DiemSo = qlttn.BaiLams.Where(bl => bl.maHS == hs.maHS && bl.maDT == bt.maDT && bl.DiemSo != null).FirstOrDefault().DiemSo,
                        SoCauDung = qlttn.BaiLams.Where(bl => bl.maHS == hs.maHS && bl.maDT == bt.maDT && bl.DiemSo != null).FirstOrDefault()
