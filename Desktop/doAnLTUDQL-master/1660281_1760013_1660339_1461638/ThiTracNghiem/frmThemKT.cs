    ...
    public partial class frmThemKT : Form
    {
            ...
            btnThemKT.Click += (s, e) =>
             {
                 ...
                 using (var qlttn = new QLTTNDataContext())
                 {
                     ...
                     qlttn.KyThiQL.InsertOnSubmit(new KyThi
                     {
                         TenKT = txtTenKT.Text,
                         maKhoi = this.maKhoi,
                         maGV = GV.maGV
                     ...
                     if (LoaiKT == "ThiThiet")
                     {
                         qlttn.KyThiQL.Where(kt => kt.maKT == maktVuaThem).FirstOrDefault().LoaiKT = "ThiThiet";
                     ...
                     {
                         qlttn.KyThiQL.Where(kt => kt.maKT == maktVuaThem).FirstOrDefault().LoaiKT = "ThiThu";
        ...
        private void LoadQLKTDgvHocSinh()
        {
            using (var qlttn = new QLTTNDataContext())
            {
                ...
                try
                {
                    ...
                    var dshsRanh = qlttn.HocSinhQL.Where(hs => hs.maKhoi == maKhoi
        ...
        private void LoadQLKTDgvDeThi()
        {
            using (var qlttn = new QLTTNDataContext())
            {
                ...
                try
                {
                    bsLichThi.DataSource = qlttn.DeThiQL.Where(dt => dt.maMH == GV.maMH)
